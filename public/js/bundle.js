...
var stripe = Stripe('pk_test_51OG6u1EIZ0pW75sWOr5ubuPKXJI4p9YW84ngEwJ8XHSSRB3n7YsWqQEREHqRADnqfi3V0AiM9dtYzsUyjO4ZmU6T00ibUSAziF');
...
var userPassword = document.querySelector('.form-user-password');
...
if (userdata) {
  ...
  userdata.addEventListener('submit', /*#__PURE__*/function () {
...
if (userPassword) {
  userPassword.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirm').value; //console.log(currentPassword, password, passwordConfirm);
            _context2.next = 7;
